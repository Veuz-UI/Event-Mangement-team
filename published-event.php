                                ...
                                <div class="btn-group btn-group-lg" role="group" aria-label="Basic example">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-sm" aria-labelledby="dropdownMenuButton" style="">
                                            <a class="dropdown-item" href="#" data-bs-target="#add-announcement" data-bs-toggle="modal"><i class="fas fa-bullhorn me-2 clr8"></i>Announcement 1</a>
                    ...
                    <div class="tab-pane active" id="manage" role="tabpanel">
                        <div class="nav-evnt-top">
                            <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#evnt-tab7" role="tab">
                                        <span>Survey</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#evnt-tab8" role="tab">
                                        <span>From Responses</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#evnt-tab9" role="tab">
                                        <span>Settings</span>
                                    </a>
                                </li>
                        ...
                        <div class="tab-content evnt-tabcontent">
                            ...
                            <div class="tab-pane" id="evnt-tab2" role="tabpanel">
                                <div class="row speaker-div team-tab-content">
                                    <div class="col-md-12">
                                        <div class="speaker-header">
                                            <div class="speaker-btns">
                                                <button type="button" class="btn btn-primary waves-effect waves-light btn-sm br-50 small"
                                                    data-bs-toggle="modal" data-bs-target="#add-registeruser">Add Register User
                                                </button>
                                            ...
                                            <div class="d-flex rightside-btns">
                                                ...
                                                <ul class="nav nav-pills event-tab-nav" role="tablist">
                                                    ...
                                                    <li class="nav-item waves-effect waves-light" role="presentation">
                                                        <a class="nav-link active" data-bs-toggle="tab" href="#register-list-tab" role="tab"
                                                            aria-selected="true">
                                                    ...
                                                    <li class="nav-item waves-effect waves-light" role="presentation">
                                                        <a class="nav-link" data-bs-toggle="tab" href="#register-grid-tab" role="tab"
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="register-list-tab" role="tabpanel">
                                                        ...
                                                        <table id="event-table" class="table table-resizable attendee-tbl">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><a class="tbl-link" href="register-user.php">AmarNath</a><span class="resize"></span></td>
                                            ...
                                            <div class="tab-pane" id="register-grid-tab" role="tabpanel">
                                                        ...
                                                        <table id="event-table" class="table table-resizable table-striped">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-end">
                                                                        <a href="#" class="delete-member" data-bs-toggle="modal" data-bs-target="#alert-delete"><i class="bx bx-trash cursor-pntr"></i></a>
                                                                        <span class="resize"></span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                            ...
                            <div class="tab-pane" id="evnt-tab6" role="tabpanel">
                                <div class="row speaker-div team-tab-content">
                                    <div class="col-md-12">
                                        <div class="speaker-header">
                                            <div class="speaker-btns">
                                                <button type="button" class="btn btn-primary waves-effect waves-light btn-sm br-50 small" data-bs-toggle="modal" data-bs-target="#add-poll">
                                                                   Add Poll
                                                                </button>
                                                                <div class="dropdown event-sett1">
                                                                    <div class="event-settings dropdown-toggle" type="button"
                                                      ...
                                                      <div class="panel-heading" role="tab" id="headingOne">
                                                        <h4 class="panel-title">
                                                          <div class="panel-collapse-title">
                                                            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" class="pnl-collapse">
                                                            ...
                                                            <div class="poll-bx">
                                                                ...
                                                                <div class="poll-scnd-box">
                                                                    <div class="poll-second-bx">
                                                                        ...
                                                                        <h6 class="mb-0"><span class="ans-no">Answer 2 </span> <span>Lower Himalayas</span></h6>                                                       
                                                                        <h6 class="mb-0"><span class="ans-no">Answer 3 </span> <span>Outer Himalayas</span></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="poll-bx">
                                                                ...
                                                                <div class="poll-scnd-box">
                                                                    <div class="poll-second-bx">
                                                                        <h6 class="mb-0"><span class="ans-no">Answer 1 </span> <span>The Sunga Dynasty</span></h6>                                                                                                                           
                                                                        <h6 class="mb-0"><span class="ans-no">Answer 2 </span> <span>Pallava Dynasty</span></h6>                                                       
                                                                        <h6 class="mb-0"><span class="ans-no">Answer 3 </span> <span>Magadha Dynasty</span></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="tab-pane" id="evnt-tab7" role="tabpanel">
                                <div class="row speaker-div team-tab-content">
                                    <div class="col-md-12">
                                        <div class="speaker-header">
                                            <div class="speaker-btns">
                                            ...
                                            <div class="d-flex rightside-btns">
                                                ...
                                                <ul class="nav nav-pills event-tab-nav" role="tablist">
                                                    ...
                                                    <li class="nav-item waves-effect waves-light" role="presentation">
                                                        <a class="nav-link active" data-bs-toggle="tab" href="#survey-list-tab" role="tab"
                                                            aria-selected="true">
                                                            <button type="button" class="btn btn-kanlist ml-15 waves-effect waves-light"
                                                                data-bs-toggle="tooltip" data-bs-placement="bottom" aria-label="List"
                                                                fdprocessedid="zf5u4">
                                                    ...
                                                    <li class="nav-item waves-effect waves-light" role="presentation">
                                                        <a class="nav-link" data-bs-toggle="tab" href="#survey-grid-tab" role="tab"
                                                            aria-selected="false" tabindex="-1">
                                                            <button type="button" class="btn btn-kanlist ml-15 waves-effect waves-light"
                                                                data-bs-toggle="tooltip" data-bs-placement="bottom" aria-label="Grid"
                                                                fdprocessedid="thdk6">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="survey-list-tab" role="tabpanel">
                                                <div class="response-tbl">
                                                    <div class="attnd-overflow">
                                                        <table id="event-table" class="table table-resizable attendee-tbl">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Survey Title<span class="resize"></span></th>
                                                                    <th>Responsible<span class="resize"></span></th>
                                                                    <th>Created At<span class="resize"></span></th>
                                                                    <th>Questions<span class="resize"></span></th>
                                                                    <th>Average Duration<span class="resize"></span></th>
                                                                    <th>Registered<span class="resize"></span></th>
                                                                    <th>Completed<span class="resize"></span></th>
                                                                    <th>Status<span class="resize"></span></th>
                                                                    <th><span class="resize"></span></th>
                                                                    <th width="100px"><span class="resize"></span></th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><a class="tbl-link" href="survey.php">Event Experience</a><span class="resize"></span></td>
                                                                    <td>Anakha<span class="resize"></span></td>
                                                                    <td>20-12-2023<span class="resize"></span></td>
                                                                    <td>2<span class="resize"></span></td>
                                                                    <td>1:30:00<span class="resize"></span></td>
                                                                    <td>0<span class="resize"></span></td>
                                                                    <td>0<span class="resize"></span></td>
                                                                    <td> <span class="tag-danger">Not Certified</span> <span class="resize"></span></td>
                                                                    <td>
                                                                        <div class="d-flex justify-content-end">
                                                                            <button type="button"
                                                                                class="btn btn-soft-primary waves-effect waves-light attandee-crfrm-btn">Publish</button>
                                                                            <!-- <button type="button"
                                                                                class="btn btn-soft-secondary waves-effect waves-light attandee-cncl-btn ms-1">Cancel</button> -->
                                                                        </div>
                                                                        <span class="resize"></span>
                                                                    ...
                                                                    <td class="text-end td-overflow">
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <div class="dropdown-menu">
                                                                                <a class="dropdown-item" href="#" data-bs-toggle="modal">Edit</a>
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 4px;"><input class="form-check-input check-input" type="checkbox"
                                                                            id="formCheck2"><span class="resize"></span></td>
                                                                    <td>2<span class="resize"></span></td>
                                                                    <td><a class="tbl-link" href="survey.php">Event Features</a><span class="resize"></span></td>
                                                                    <td>Anakha<span class="resize"></span></td>
                                                                    <td>20-12-2023<span class="resize"></span></td>
                                                                    <td>2<span class="resize"></span></td>
                                                                    <td>1:30:00<span class="resize"></span></td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a class="tbl-link" href="survey.php">Event Rating</a><span class="resize"></span></td>
                                                                    <td>Anakha<span class="resize"></span></td>
                                                                    <td>20-12-2023<span class="resize"></span></td>
                                                                    <td>2<span class="resize"></span></td>
                                                                    <td>1:30:00<span class="resize"></span></td>
                                            ...
                                            <div class="tab-pane" id="survey-grid-tab" role="tabpanel">
                                               <div class="attendee-grid">
                                                <div class="row">
                                                    <div class="col-md-2 margin-box-this">
                                                        <div class="attendee-box h-100">
                                                            <div class="row d-flex align-items-center">
                                                                <div class="col-lg-12 data-box">
                                                                    ...
                                                                    <div class="data-box-contnt">
                                                                        ...
                                                                        <h4>Responsible : <span class="sponser-type dark-content">Anakha</span></h4>
                                                                        <h4 style="margin-bottom: 7px;">Created At : <span class="sponser-type dark-content">20-12-2023</span></h4>
                                                                        <h4>Status : <span class="sponser-type associate">Not Certified<span></span></span></h4>
                                                                    </div>
                                                                    <div class="dropdown print-mail-dropdwn">
                                                                        <div class="event-settings dropdown-toggle"
                                                                            type="button" id="dropdownMenuButton"
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-sm"
                                                                            ...
                                                                            <a class="dropdown-item" href="#">See Result</a>
                                                                ...
                                                                <div class="col-lg-12 attended-text d-flex justify-content-end">
                                                                    <button type="button"
                                                                    class="btn btn-soft-primary waves-effect waves-light attandee-crfrm-btn">Publish</button>
                            ...
                            <div class="tab-pane" id="evnt-tab8" role="tabpanel">
                                <div class="row speaker-div team-tab-content">
                                    <div class="col-md-12">
                                        <div class="speaker-header">
                                            <div class="speaker-btns">
                            ...
                            <div class="tab-pane" id="evnt-tab9" role="tabpanel">
                                <div class="row speaker-div team-tab-content">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel"> <img src="assets/images/poll/poll.svg" alt=""><span>Create Poll</span></h5>
