...
<body>
    ...
    <section class="onscreen-section onscreen-section1">
                ...
                <div class="col-md-12">
                    <div class="evt-left">
                        ...
                        <div class="evt-left-bottom">
                                ...
                                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4">
                                    ...
                                    <div class="col">
                                        <div class="logo-div">
                                           ...
                                           <div class="vote-percentage">
                                                <h4>30%<i class="bx bx-down-arrow-alt low"></i></h4>
                                           </div>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="logo-div">
                                           ...
                                           <div class="vote-percentage">
                                                <h4>60%<i class="bx bx-up-arrow-alt medium"></i></h4>
                                           </div>
                                        </div>
                                    </div>
                                    <div class="col">
                            ...
                            <h3>Participation of the best companies in Saudi Arabia 2023 ?  </h3>
                            <div class="company-logos company-disc">
                                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4">
                                    <div class="col">
                                        <div class="logo-div">
                                            <div class="company-log">
                                                <h2>Functional primitives</h2>
                                            </div>
                                           <div class="vote-percentage">
                                                <h4>50%<i class="bx bx-up-arrow-alt medium"></i></h4>
                                           </div>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="logo-div">
                                           ...
                                           <div class="vote-percentage">
                                                <h4>20%<i class="bx bx-down-arrow-alt low"></i></h4>
                                           </div>
                                        </div>
                                    </div>
                                    <div class="col">
